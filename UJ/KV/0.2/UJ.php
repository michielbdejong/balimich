...
class UnhostedJSONParser {
	...
	private $fields = array(
		'UJJP/0.2;KeyValue-0.2' => array(
		      'GET' => array('storageNode' => true, 'app' => true, 'protocol' => 'UJJP/0.2;KeyValue-0.2', 'command' => array(
						'user' => true, 'method' => 'GET', 'keyHash' => true)
					),
	              'SET' => array('storageNode' => true, 'app' => true, 'protocol' => 'UJJP/0.2;KeyValue-0.2', 'command' => array(
						'user' => true, 'method' => 'SET', 'keyHash' => true, 'value' => true
					), 'pubSign' => true, 'password' => true),
		            //
		 'REGISTER' => array('storageNode' => true, 'app' => true, 'protocol' => 'UJJP/0.2;KeyValue-0.2', 'command'=>array(
						'method' => 'REGISTER', 'user' => true
					), 'password' => true),
		  'CONFIRM' => array('storageNode' => true, 'app' => true, 'protocol' => 'UJJP/0.2;KeyValue-0.2', 'command'=>array(
						'method' => 'CONFIRM', 'user' => true
					), 'registrationToken' => true, 'password' => true),
		'DISAPPEAR' => array('storageNode' => true, 'app' => true, 'protocol' => 'UJJP/0.2;KeyValue-0.2', 'command'=>array(
						'method' => 'DISAPPEAR', 'user' => true
					), 'password' => true),
		 'GETSTATE' => array('storageNode' => true, 'app' => true, 'protocol' => 'UJJP/0.2;KeyValue-0.2', 'command'=>array(
						'method' => 'GETSTATE', 'user' => true
					), 'password' => true),
		 'EMIGRATE' => array('storageNode' => true, 'app' => true, 'protocol' => 'UJJP/0.2;KeyValue-0.2', 'command'=>array(
					'method' => 'EMIGRATE', 'user' => true, 'toNode' => true
					), 'password' => true, 'migrationToken' => true),
		'IMMIGRATE' => array('storageNode' => true, 'app' => true, 'protocol' => 'UJJP/0.2;KeyValue-0.2', 'command'=>array(
						'method' => 'IMMIGRATE', 'user' => true, 'fromNode' => true
					), 'migrationToken' => true, 'password' => true),
		  'MIGRATE' => array('storageNode' => true, 'app' => true, 'protocol' => 'UJJP/0.2;KeyValue-0.2', 'command'=>array(
