...
require_once BASE_DIR . 'MessageQueues.php';//for migration
...
class Accounts {
	...
	public static function migrate($accountId, $partition, $migrationToken, $keyPath, $needValue, $delete, $limit) {
		...
		return MessageQueues::export($accountId, $partition, $keyPath, $needValue, $delete, $limit);
	}
	public static function doMigration($user, $storageNode, $app, $keyPath) {
		...
		$success = MessageQueues::import($accountId, $partition, $objects);
