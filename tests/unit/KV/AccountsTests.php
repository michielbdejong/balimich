...
class AccountsTests extends UnitTests {
	function testRegistration() {
		...
		try {
			Accounts::immigrate('newco@hotmail.com', 'mlsn.org', 'testApp.org', 'newcoPass', 'moving', 'elsewhere.org');
	...
	function testEmigration() {
		...
		echo "(test gone pub)";
		try {
			Security::getAccountIdWithPassword('gobabygogo@hotmail.com', 'mlsn.org', 'testApp.org', 'gobabygogoPub');
			$this->assertDontReachHere('test gone');
		} catch (HttpRedirect $e) {
			$this->assertEqual($e->getMessage(), "faraway.org");
		}
